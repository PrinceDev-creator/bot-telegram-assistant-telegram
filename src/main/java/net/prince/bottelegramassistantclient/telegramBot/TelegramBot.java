package net.prince.bottelegramassistantclient.telegramBot;

import jakarta.annotation.PostConstruct;
import net.prince.bottelegramassistantclient.agents.AIAgent;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update telegraRequest) {
        try {
            ...
            // ✅ chatId utilisé comme conversationId
            String answer = aiAgent.askAgent(messageText, String.valueOf(chatId));
